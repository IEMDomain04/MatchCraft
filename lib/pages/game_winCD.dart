...
class GameWinScreenCD extends StatefulWidget {
  final int duration;
  final int moves;
  final bool is4x4;

  const GameWinScreenCD({
    Key? key,
  ...
  @override
  State<GameWinScreenCD> createState() => _gameWinScreenState();
}

class _gameWinScreenState extends State<GameWinScreenCD> {
  ...
  void saveDataToFirebase(String name, int time, int moves, bool is4x4) async {
    ...
    String collectionName = is4x4 ? '4x4 CD Rankings' : '6x6 CD Rankings';
          ...
          Container(
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage("assets/MatchCraftBG5.png"),
                fit: BoxFit.fill,
              ),
            ),
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  SizedBox(height: 120),
                  Text(
                    is4x4 ? "Countdown Result 4x4" : "Countdown Result 6x6",
                    style: TextStyle(
                      color: Colors.yellow,
