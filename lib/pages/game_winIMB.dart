...
class GameWinScreenIMB extends StatefulWidget {
  final int duration;
  final int moves;
  final bool is4x4;

  const GameWinScreenIMB({
    Key? key,
  ...
  @override
  State<GameWinScreenIMB> createState() => _gameWinScreenState();
}

class _gameWinScreenState extends State<GameWinScreenIMB> {
  ...
  void saveDataToFirebase(String name, int time, int moves, bool is4x4) async {
    ...
    String collectionName = is4x4 ? 'IMB Rankings' : 'IMB Rankings';
          ...
          Container(
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage("assets/MatchCraftBG6.png"),
                fit: BoxFit.fill,
              ),
            ),
            child: Padding(
